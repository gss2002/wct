...
//		}
	...
	public static String splitIntoMultipleLines(String str, int maxNumChars) {
		
     	StringBuilder sb = new StringBuilder();
    	String line = "";
    	
    	System.out.println("input: "+str);
    	System.out.println("arrays: "+Arrays.toString(str.split(" +")));
    	
    	str = str.replace("\n", " \n");
    	for (String s : str.split(" +")) {
    		if (line.length() + s.length() < maxNumChars) {
    			sb.append(s).append(" ");
    			line = line + " " +s;
    		}
    		else {

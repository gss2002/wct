...
public class SnapshotLayer {
	...
	public static enum DefaultLegendType { LARGE, MEDIUM };
    ...
    private DefaultLegendType defaultLegendType;
    private CategoryLegendImageProducer legendProducer;
    
    private int[][][] originalAlphaValues = null;
    
    public void setRaster(WCTRaster raster) {
    	this.raster = raster;
    }
    
    public WCTRaster getRaster() {
    	return this.raster;
    }
...
//        	System.out.println(originalAlphaValues);
	...
	public DefaultLegendType getDefaultLegendType() {
		return defaultLegendType;
	}

	public void setDefaultLegendType(DefaultLegendType defaultLegendType) {
		this.defaultLegendType = defaultLegendType;
	}

	public CategoryLegendImageProducer getLegendProducer() {
		return legendProducer;
	}

	public void setLegendProducer(CategoryLegendImageProducer legendProducer) {
		this.legendProducer = legendProducer;
	}

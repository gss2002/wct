...
//            @Override
            public void actionPerformed(ActionEvent e) {
                try {
                    WCTUiUtils.browse(viewer, "http://droughtmonitor.unl.edu/", "Error browsing to http://droughtmonitor.unl.edu/");
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(viewer, "No Default Browser found.\n"+
                            "Please direct you browser to \" http://droughtmonitor.unl.edu/ \"", 

...
public interface NexradHeader {
   ...
   /**
    *  General Level-3 Message Data  (Product Type)
    */
   public final static int L3MSG = -36;
...
//   public final static int L3GENERIC_RADIAL = -39;
   ...
   /**
    *  Actual Level-3 FTM Product Code <br>
    *  AWIPS HEADER CODE: FTM <br>
    *  PRODUCT CODE: 5
    */
   public final static int L3PC_FTM = 5;
   ...
   /**
    *  Actual Level-3 Low-Layer Composite Reflectivity 124 nmi Range 16 Level Product Code with AP removed<br>
    *  AWIPS HEADER CODE: NLA <br>
    *  PRODUCT CODE: 67
    */
   public final static int L3PC_LOW_LAYER_COMP_REFLECTIVITY_AP_REMOVED = 67;
   ...
   /**
    *  Actual Level-3 Storm Tracking Product Code <br>
    *  AWIPS HEADER CODE: NST <br>
    *  PRODUCT CODE: 58
    */
   public final static int L3PC_STORM_TRACKING = 58;
   
   /**
    *  Actual Level-3 Hail Product Code <br>
    *  AWIPS HEADER CODE: NHI <br>
    *  PRODUCT CODE: 59
    */
   public final static int L3PC_HAIL_INDEZX = 59;

   /**
    *  Actual Level-3 Legacy Meso Product Code <br>
    *  AWIPS HEADER CODE: NME <br>
    *  PRODUCT CODE: 60
    */
   public final static int L3PC_MESOCYCLONE = 60;

   /**
    *  Actual Level-3 TVS Product Code <br>
    *  AWIPS HEADER CODE: NTV <br>
    *  PRODUCT CODE: 61
    */
   public final static int L3PC_TVS = 61;

   /**
    *  Actual Level-3 Storm Structure Product Code <br>
    *  AWIPS HEADER CODE: NSS <br>
    *  PRODUCT CODE: 62
    */
   public final static int L3PC_STORM_STRUCTURE = 62;

   /**
    *  Actual Level-3 Digital Meso Product Code <br>
   ...
   /**
    *  Actual Level-3 Melting Layer Product Code <br>
    *  AWIPS HEADER CODE: N0M,NAM,N1M,NBM,N2M,N3M <br>
    *  PRODUCT CODE: 166
    */
   public final static int L3PC_MELTING_LAYER = 166;

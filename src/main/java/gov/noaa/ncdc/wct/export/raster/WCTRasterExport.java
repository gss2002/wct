...
//    	Revamped 5/1/2015
		GridDataset gds = GridDataset.open(tmpFile.toString());
		GridDatatype grid = gds.findGridByName(wctRaster.getVariableName());
		GeotiffWriter writer1 = new GeotiffWriter(f.toString());
...
//		System.out.println(grid.getMinMaxSkipMissingData(data));
        ...
        if (type == GeoTiffType.TYPE_8_BIT) {
        	writer1.writeGrid(gds, grid, data, true);
        }

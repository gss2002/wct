...
public class FileScanner {
    ...
    private static final SimpleDateFormat goesDateFormat = new SimpleDateFormat("yyyy.DDD.HHmmss", Locale.ENGLISH);
    private static final SimpleDateFormat wctTimestampFormat = new SimpleDateFormat("yyyyMMdd HH:mm:ss", Locale.ENGLISH);

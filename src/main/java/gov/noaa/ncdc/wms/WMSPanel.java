...
//			jbBackground[0].setEnabled(false); // no layer choices for most background images index = 0
			...
			showDefaultButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					LayerSelector mapSelect = nexview.getMapSelector();
			...
			JButton testTileMaps = new JButton("Test Tile Map Overlay");
			testTileMaps.addActionListener(new ActionListener() {
//				@Override
				public void actionPerformed(ActionEvent e) {
					try {
						testTileMaps();
...
//			mapBGPanel.add(testTileMaps, "left hfill");
...
//				}
	...
	private void testTileMaps() throws MalformedURLException, WMSException, TransformException {
...
//		Rectangle rect = nexview.getMapPane().getWCTZoomableBounds(new java.awt.Rectangle());
		...
		{
			URL url = new URL("http://tile.stamen.com/terrain/5/8/13.jpg");
			Rectangle2D.Double extent = new Rectangle2D.Double(-90, 21.94304553343818, -78.75 - -90, 31.95216223802497 - 21.94304553343818);
			...
			nexview.setWMSBackground(2, gc);
		}
		
		{
			URL url = new URL("http://a.basemaps.cartocdn.com/dark_all/5/8/12.png");
			Rectangle2D.Double extent = new Rectangle2D.Double(-90, 31.95216223802497, -78.75 - -90, 40.979898069620155 - 31.95216223802497);
		...
		{
			URL url = new URL("http://tile.openstreetmap.org/5/8/11.png");
			Rectangle2D.Double extent = new Rectangle2D.Double(-90, 40.979898069620155, -78.75 - -90, 48.922499263758255 - 40.979898069620155);

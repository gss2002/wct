    		...
    		try {
    			...
    			while (listResults.next()) {
    				if (listResults.getType() == FtpListResult.FILE || 
    					...
    					list.add(new FileInfo(Type.FILE, listResults.getName(), remoteDirectory, listResults.getDate(), listResults.getSize()));
    				}
    				else if (listResults.getType() == FtpListResult.DIRECTORY) {
    					list.add(new FileInfo(Type.DIRECTORY, listResults.getName(), remoteDirectory, listResults.getDate(), listResults.getSize()));
    				}
    			}

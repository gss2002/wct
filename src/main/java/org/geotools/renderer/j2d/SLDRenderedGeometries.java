...
//        double newScale = context.getAffineTransform(context.mapCS, context.textCS).getScaleX();
        // steve ansari addition
//        if (newScale != currentScale) {
//        	//        SLDRenderedGeometriesLabelManager.registerObject(this);        
//        	rectList.clear();
//        	rectIndex = 0;
//        	System.out.println("cleared rectList");
//
...
//            System.out.println("Out of scale");
        ...
        if (style instanceof MarkStyle2D) {
            ...
            if(ts2d.getFill() != null) {
                ...
                // sansari addition
//                Rectangle pixelRect = textGv.getPixelBounds(textGv.getFontRenderContext(), 0, 0);
//                System.out.println(textGv.toString());
//                System.out.println(pixelRect);
//                System.out.println(" ");
//            	graphics.setStroke(new BasicStroke(1.0f));
//            	graphics.setPaint(Color.WHITE);
//            	XRectangle2D rect = XRectangle2D.createFromExtremums(pixelRect.getMinX(), pixelRect.getMinY(), pixelRect.getMaxX(), pixelRect.getMaxY());
//            	graphics.drawRect((int)Math.round(rect.getMinX()), (int)Math.round(rect.getMinY()), 
...
//
//                			// TODO - add some auto shifting/moving of labels to avoid conflicts
////              			if (declutterType == 0) {
////                			}
//                			return;
//                		}
...
//                	System.out.println(rectList.size()+" rects stored for label filtering");
//                }                
                // end sansari
